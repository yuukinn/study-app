<x-app-layout>
    <div class="grid grid-cols-4">
        ...
        <div class="col-span-1 bg-white rounded p-4">
            ...
            <h3 class="text-2xl font-bold mb-2">レシピを投稿</h3>
            <ul class="ml-6 mb-4">
                <li><a href="#">すべてのレシピ</a></li>
                <li><a href="#">人気のレシピ</a></li>
            </ul>
        ...
        <div class="col-span-2 bg-white rounded p-4">
         ...
         @foreach($recipes as $recipe)
            <a href="#" class="flex flex-col items-center bg-white mb-6 border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100">
        ...
        <div class="col-span-1 bg-gray ml-4">1</div>
    </div>
</x-app-layout>
